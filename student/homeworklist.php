...
h.year='" . addslashes($_POST['c1']) . "' AND h.semester='" . addslashes($_POST['c2']) . "' 
AND h.classe = '" . $classe . "' AND
h.date >= CURDATE() AND h.date <= CURDATE()+7 
ORDER BY date";
			...
			<br>
			<center><input name="b2" type="submit" class="btn btn-success" value="Zurück" id="b2"></center>
			<?php
		}
	}
	?>
