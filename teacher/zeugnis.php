...
FROM averagetotal 
WHERE student ='" . addslashes($_SESSION['student']) . "'AND
 semester='" . addslashes($_SESSION['semester']) . "' AND
 year='" . addslashes($_SESSION['year']) . "'
...
$student = mysqli_query($cn, "SELECT name, firstname, birthdate FROM student WHERE code='" . addslashes($_SESSION['student']) . "'");
...
$pdf->Cell(50);
$pdf->Cell(30, 10, 'Klass ' . $_SESSION['classe']);
$pdf->Cell(25);
$pdf->Cell(30, 10, $_SESSION['semester'] . ' ' . $_SESSION['year']);
$pdf->Ln();
$pdf->SetFont('freeserif', ' ', 12);
$pdf->Cell(30, 10, '__________________________________________________________________________________________', 'C');
$pdf->Ln(20);
...
$pdf->Output('Zeugnis ' . $_SESSION['semester'] . ' ' . $_SESSION['year'] . '.pdf', 'I');
?>