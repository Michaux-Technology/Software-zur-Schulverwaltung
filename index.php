                ...
                <table width="300" border="0">
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" name="t1" id="t1" maxlength="15"><br></td>
                    </tr>
                    <tr>
                      <th scope="row"><label for="textfield7">Passwort </label></th>
                      <td><input type="password" name="t2" id="t2" maxlength="15"><br></td>
                    </tr>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h3>Unsere Schule</h3><br>

        </div>
      </div>
      <div class="row">
        <div class="col-md-6 text-center">
          <img src="img/400x400.jpg " alt="">
          <h2>Der Eingang</h2>

        </div>
        <div class="col-md-6 text-center">
          <img src="img/400x4001.jpg" alt="">
          <h2>Der Spielplatz</h2>
